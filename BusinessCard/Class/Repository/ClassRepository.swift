...
struct ClassRepository {
    
    let defaults = UserDefaults.standard
    
    func getStudents() -> AnyPublisher<[StudentModel], Error> {
        
        return Just(URL(string: "http://emarest.cz.mass-php-1.mit.etn.cz/api/v2/participants"))
